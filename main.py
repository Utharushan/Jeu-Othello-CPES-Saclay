...
def menu():
    ...
    while running:
        ...
        titre = font.render("Othello", True, BLANC)
        screen.blit(titre, (DIMENSION//2 - 40, 100))
        btn1 = pygame.Rect(DIMENSION//2 - 100, 200, 200, 50)
        btn2 = pygame.Rect(DIMENSION//2 - 100, 300, 200, 50)
        ...
        screen.blit(txt1, (btn1.x + 50, btn1.y + 10))
        screen.blit(txt2, (btn2.x + 30, btn2.y + 10))
        pygame.display.flip()
...
def boucle_jeu(mode):
    ...
    while True:
        coups = lister_coups_valides(plateau, joueur)
        dessiner_plateau(plateau, coups)
        pygame.display.flip()
